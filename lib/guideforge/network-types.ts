...
export const NETWORK_TYPE_REGISTRY: NetworkTypeEntry[] = [
  {
    ...
    keywords: [
      ...
      "mmo", "steam", "dota", "wow", "world of warcraft", "raid", "raid guide",
      "dungeon", "esports", "fps", "moba", "roguelike", "crafting", "sandbox",
      "speedrun", "deckbuilder", "soulslike", "walkthrough", "patch notes",
      "tier list", "pvp", "pve", "loot", "character build", "loadout",
      "beginner tutorial", "class build", "competitive",
    ],
    enabled: true,
  },
  {
    ...
    scaffoldKey: "repair",
    keywords: [
      "repair", "fix", "troubleshoot", "troubleshooting", "diagnostic",
      "diagnostics", "broken", "maintenance", "laptop", "computer",
      "computer troubleshooting", "printer", "printer problem", "phone",
      "phone repair", "mobile", "device", "hardware", "battery", "screen",
      "wifi", "wi-fi", "wifi issue", "network issue", "tool", "safety",
      "procedure", "tech repair", "technician", "junior technician",
      "step-by-step", "step by step", "repair checklist", "escalation",
      "home users", "home user", "support",
    ],
    enabled: true,
  },
  {
    ...
    scaffoldKey: null,
    keywords: [
      "youtube", "streaming", "content creator", "creator community",
      "thumbnail", "editing", "publishing", "newsletter", "podcast", "twitch",
      "tiktok", "analytics", "monetize", "channel", "audience", "social media",
      "video", "clip", "discord", "discord community", "community management",
      "sponsorship", "sponsorship readiness", "brand",
    ],
    enabled: true,
  },
  {
    ...
    keywords: [
      ...
      "branding", "website", "onboarding", "operations", "daily operations",
      "freelance", "invoice", "contract", "marketing", "offers", "agency",
      "revenue", "sop", "customer support", "customer intake", "intake",
      "quality control", "quality check", "escalation procedure",
      "escalation procedures", "service business", "sales",
    ],
    enabled: true,
  },
  {
  ...
  },
  {
    ...
    keywords: [
      ...
      "home improvement", "renovation", "appliance", "seasonal", "family",
      "kids", "school", "meal", "meal planning", "budget", "budgeting",
    ],
    enabled: true,
  },
  {
