    ...
    <section id="how" className="border-b border-border">
      <div className="mx-auto w-full max-w-6xl px-4 py-16 md:px-6 md:py-20">
        <div className="mb-10 flex flex-col gap-3 md:max-w-2xl">
          <span className="gf-eyebrow">How it works</span>
        ...
        <ol className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          {STEPS.map((step) => (
            <li
              key={step.n}
              className="card-foundry rounded-xl p-6"
            >
              <div className="font-mono text-xs font-semibold tracking-widest text-gf-copper">
                {step.n}
              </div>
